...
final class Version20240127183621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, test_count INT NOT NULL, assertion_count INT NOT NULL, error_count INT NOT NULL, warning_count INT NOT NULL, failure_count INT NOT NULL, skip_count INT NOT NULL, time DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
